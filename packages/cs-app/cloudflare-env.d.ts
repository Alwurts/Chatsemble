...
// Runtime types generated with workerd@1.20250317.0 2024-09-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		CHAT_DURABLE_OBJECT: DurableObjectNamespace<import("../cs-api/src/index").ChatDurableObject>;
		AGENT_DURABLE_OBJECT: DurableObjectNamespace<import("../cs-api/src/index").AgentDurableObject>;
	}
}
